...
var config = {
    ...
    scenarios: {
        ...
        matchers: {
            anyMatcher: function(reqContext, scenarioState) { return true; },
            requestKeyMatcher: function(reqContext, scenarioState) { return _.isEqual(reqContext.requestKey, scenarioState.requestKey); }
        }
    }
};


var googleScenario = new Scenario({
    "key": "google",
    "title": "Google Test Scenario",
    "repeatability": $nocca.$constants.Scenarios.Repeatability.INFINITE,
    "type": $nocca.$constants.Scenarios.Type.SEQUENTIAL,
    "sequence": [
        {
            "on": "google",
            "title": "Get Google BooBoo Page",
            "matchUsing": "anyMatcher",
