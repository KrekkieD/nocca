...
angular.module("nocca.utils").run(['$templateCache', function($templateCache) {$templateCache.put("download-dialog.directive.html","<div> <md-content> <md-input-container flex=\"33\"> <label>Filename</label> <input ng-model=\"download.filename\"> </md-input-container> </md-content> <div class=\"md-actions\"> <md-button ng-click=\"cancel()\">Cancel</md-button> <md-button ng-click=\"save()\">Save</md-button> </div> </div>");}]);
(function() {
    'use strict';
...
(function() {
    ...
    noccaUtilsDownload.$inject = ['noccaUtilsSaveAs', '$http', '$mdDialog', 'localStorageService'];
...
(function() {
    ...
    function DownloadDialogDirective () {
        ...
        DownloadDialogDirectiveController.$inject = ['$scope', '$mdDialog', 'localStorageService'];
        return directive;
