    ...
    function log (reqContext) {
        ...
        if (typeof stats.responses[requestKeyHash] === 'undefined') {
            ...
            stats.responses[requestKeyHash] = {
                ...
                request: $extend({}, reqContext.getClientRequest()),
                proxiedRequest: reqContext.getProxyRequest() ? $extend({}, reqContext.getProxyRequest()) : null,
                proxiedResponse: reqContext.getProxyResponse() ? $extend({}, reqContext.getProxyResponse()) : null,
                response: $extend({}, reqContext.getClientResponse()),
