    ...
    function log (reqContext) {
        ...
        switch (flagString) {
            case '110':
                ...
                _tell('Request on ' + reqContext.endpoint.key + ' recorded and forwarded', {rec: true, fwd: true});
            ...
            case '010':
                ...
                _tell('Request on ' + reqContext.endpoint.key + ' forwarded', {fwd: true});
            ...
            case '001':
                ...
                _tell('Request on ' + reqContext.endpoint.key + ' replayed', {rpl: true});
