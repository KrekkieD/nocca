...
var $requestContextConstructor = require('./requestContext');
...
module.exports = {
    ...
    requestContextConstructor: $requestContextConstructor,
    ...
    playback: {
        ...
        // We seriously have to change this crap :P
        scenarioResetter: $playback.resetScenario
    },
    requestForwarder: $forwarder.simpleForwarder,
    responder: $responder,
