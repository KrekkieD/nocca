...
function cacheQueue (Nocca) {
    ...
    this.name = function () { return module.exports.name; };

    this.setCaches = setCaches;
    this.considerRecording = considerRecording;
    ...
    Nocca.pubsub.subscribe('CACHE_QUEUE_SET_CACHES', setCaches);
    ...
    function _init () {
        ...
        var routes = [
            ...
            //['DELETE:/plugins/cacheQueue/list/', tbd],
            ...
            // feed caches
            //['PUT:/plugins/cacheQueue/caches', setCaches],

            // export recorded caches
            ['GET:/plugins/cacheQueue/recorded-caches', getRecordedCaches]
        ];
    ...
    function matchRequest (reqContext) {
        ...
        if (typeof cache !== 'undefined') {
            console.log('cacheQueue is serving a response!');
    ...
    function CacheList (caches) {
        ...
        function consume (reqContext) {
            ...
            if (typeof self.repository.caches[numberedCacheKey] !== 'undefined') {
                ...
                if (self.empty) {
                    console.log('Repository emptied!');
                }
                else {
                    // show progress
                    var progress = [];
    ...
    function getRecordedCaches (apiReq) {
