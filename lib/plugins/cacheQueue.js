...
function cacheQueue (Nocca) {
    ...
    function _init () {
        ...
        var routes = [
            ...
            ['DELETE:/plugins/cacheQueue/caches', apiDeleteCaches],

            // feed caches
            ['PUT:/plugins/cacheQueue/caches', apiSetCaches],

            // export recorded caches
            ['GET:/plugins/cacheQueue/recorded-caches', apiGetRecordedCaches]
        ];
    ...
    function setCaches (cacheArray) {
        ...
        if (Array.isArray(cacheArray)) {
            ...
            console.log(cacheArray.length + ' caches!');
