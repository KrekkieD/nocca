...
function CacheQueue (Nocca) {
    ...
    function setCaches (cacheArray) {
        ...
        if (Array.isArray(cacheArray)) {
            ...
            self.logger.info('Setting caches with length of ' + cacheArray.length);
    ...
    function CacheList (caches) {
        ...
        function consume (reqContext) {
            ...
            if (typeof self.repository.caches[numberedCacheKey] !== 'undefined') {
                ...
                if (self.empty) {
                    self.logger.debug('All caches in CacheQueue repository were hit! No caches remaining.');
                }
                else {
                    ...
                    self.logger.debug('CacheQueue progress: ' + progress.join('|'));
