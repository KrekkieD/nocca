        ...
        if (transformation.replace.type === 'math') {
            ...
            return function (match, submatch) {
                ...
                if (typeof options.diff !== 'undefined') {
                    ...
                    //console.log(date.format('x'), 'body message time');
                    //console.log(messageTime.format('x'), 'created message time');
                    //console.log(msDiffTime, 'difference');
                    //console.log(currentTime.format('x'), 'current time');

                    // then process that diff on to the current time
                    if (msDiffTime < 0) {
                        msDiffTime = msDiffTime * -1;
                        //console.log(msDiffTime);
                    ...
                    //console.log(date.format('x'), 'diffed', '\n');
