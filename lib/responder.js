...
function Responder (Nocca) {
    ...
    function _delayResponsePerConfiguration (reqContext) {
        ...
        reqContext.requestDelayed = Math.max(reqContext.config.delay - (reqContext.requestRespondTime - reqContext.requestStartTime), 0);
