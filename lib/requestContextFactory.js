...
function requestContextFactory (Nocca) {
    ...
    function RequestContext(httpRequest, httpResponse, startTime, config) {
        ...
        this.requests = {
            ...
            clientRes: Nocca.httpMessageFactory.importAsOutgoingResponse(httpRequest)
        };
        ...
        function start () {
            ...
            chain.catch(Nocca.config.throwHandlerFactory(self.httpResponse));
        ...
        function generateKey (reqContext) {
            ...
            return reqContext.config.keyGenerator(reqContext);
        ...
        function replayIfDesired (reqContext) {
            ...
            if (reqContext.config.forward === Nocca.constants.FORWARDING_FORWARD_NONE ||
                ...
                deferred.resolve(reqContext.config.playback.matcher(reqContext));
