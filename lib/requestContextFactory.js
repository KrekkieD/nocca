...
function requestContextFactory (Nocca) {
    ...
    function RequestContext(httpRequest, httpResponse, startTime, config) {
        ...
        this.flagForwarded = false;
        this.flagRecorded = false;
        this.flagReplayed = false;
        ...
        function isForwarded (bool) {
            return _flag('flagForwarded', bool);
        }
        function isReplayed (bool) {
            return _flag('flagForwarded', bool);
        }
        function isRecorded (bool) {
            return _flag('flagForwarded', bool);
        }
        function isMissed (bool) {
            return _flag('flagForwarded', bool);
        }

        function _flag (property, value) {
