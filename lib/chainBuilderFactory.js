...
function defaultChainBuilderFactory(opts) {
    ...
    return function(context) {
        ...
        if (opts.forward === $constants.FORWARD_NONE || opts.forward === $constants.FORWARD_MISSING) {
        ...
        if (opts.forward === $constants.FORWARD_ALL || opts.forward === $constants.FORWARD_MISSING) {
